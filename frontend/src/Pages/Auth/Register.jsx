...
export default function Register() {
  ...
  // Animate form entrance like Login
  useEffect(() => {
  ...
  return (
    <div className="bg-[#0B1220] min-h-screen font-syne" style={{ position: 'relative', overflowY: 'auto', maxHeight: '100vh' }}>
      ...
      <div className="relative py-12 px-8 flex justify-center">
        ...
        <div className="w-full max-w-lg relative z-10">
          ...
          `}</style>
          <div className="card p-10 shadow-cyan" style={{ ...revealStyle(0), maxHeight: '80vh', overflowY: 'auto' }}>
            {/* Logo */}
